...
export const ViewOnOpenSaucedButton = (username: string) => {
    const viewOnOpenSaucedButton = createHtmlElement("a", {
        ...
        className: "inline-block my-2 text-black bg-gh-white dark:bg-gh-gray dark:text-white rounded-md p-2 text-sm font-semibold text-center select-none w-full border hover:shadow-button hover:no-underline",
        target: "_blank",
