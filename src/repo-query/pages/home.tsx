...
export const Home = ({
    ...
    >
        ...
        <p className="text-sm text-gray-500 w-5/6 text-center mt-4">
            With RepoQuery, you can ask questions about {ownerName}/{repoName}{" "}
            and get answers with the help of AI.
            <br />
            For RepoQuery to work on a repository, it needs to be indexed by us
            first. Click below to check if this repository is indexed and start
            the conversation!
        </p>
