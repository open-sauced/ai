...
export const InviteToOpenSaucedButton = () => {
  const inviteToOpenSaucedButton = createHtmlElement("a", {
    className:
      "inline-block mt-4 mb-1 text-white rounded-md p-2 no-underline text-md font-semibold text-center select-none w-full border border-solid cursor-pointer bg-[#21262d] hover:bg-[#ED5432]",
    innerHTML: `<img
