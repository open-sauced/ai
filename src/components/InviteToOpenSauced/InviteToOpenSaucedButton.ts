...
export const InviteToOpenSaucedButton = () => {
  const inviteToOpenSaucedButton = createHtmlElement("a", {
    className:
      "inline-block mt-4 text-white rounded-md p-2 text-sm font-semibold text-center select-none w-full border border-solid cursor-pointer bg-[#21262d] hover:bg-[#ED5432] hover:shadow-button hover:no-underline",
    innerHTML: `<img
